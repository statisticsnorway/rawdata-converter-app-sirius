...
public class Application extends RawdataConverterApplication {
    ...
    public static void main(String[] args) {
        log.info("rawdata-converter-app-sirius version: {}", MavenArtifactUtil.findArtifactVersion("no.ssb.rawdata.converter.app", "rawdata-converter-app-sirius").orElse("unknown"));
